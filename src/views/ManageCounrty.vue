    ...
    <div class="flex flex-col items-center">
      <div class="w-full max-w-4xl mb-4">
        ...
        <div class="flex flex-col justify-between items-center mb-3">
           <h1 class="text-5xl font-bold text-center text-[#08D9D6]">MENAGE COUNTRY</h1>
        </div>

        <div class="flex flex-col justify-between items-center mb-9">
           <!-- Add Country Button -->
           <button
              @click="navigateToCountryForm"
              class="px-7 py-5 bg-[#FF2E63] text-[#EAEAEA] rounded hover:bg-[#FF4B7E] mb-4 sm:mb-0"
            >
            <font-awesome-icon :icon="['fas', 'plus']" /> Add Country 
            </button>
        </div>
